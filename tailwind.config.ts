  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        danger: "#E63946",       // Updated danger red
        warning: "#F4A261",      // Updated warning orange
        success: "#2A9E76",      // Success green (teal-based)
        info: "#457B9D",         // Info blue (more muted)
        dark: {
        ...
        alert: {
          error: "#E63946",      // Updated to match new scheme
          success: "#2A9E76",    // Updated to match new scheme
          warning: "#F4A261",    // Updated to match new scheme
          info: "#457B9D",       // Updated to match new scheme
          neutral: "#6B7280",
        },
        social: {
          facebook: "#3b5998",
